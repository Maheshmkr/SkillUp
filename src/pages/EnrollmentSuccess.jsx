      ...
      <header className="flex items-center justify-between border-b border-border px-10 py-3 bg-card shadow-sm">
        <div className="flex items-center gap-8">
          ...
          <nav className="hidden md:flex items-center gap-9">
            ...
            <Link to="/dashboard" className="text-muted-foreground text-sm font-medium hover:text-primary transition-colors">My Courses</Link>
          </nav>
        </div>
      </header>
      ...
      <main className="px-4 flex flex-1 justify-center py-12">
        <div className="flex flex-col max-w-[720px] flex-1">
            ...
            <div className="p-8 text-center md:text-left">
              <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="flex-1">
                  <h3 className="text-xl font-semibold mb-2">Mastering Modern UI/UX</h3>
                  <p className="text-muted-foreground text-base leading-relaxed">
                    Your journey into Advanced UI Design starts now. We've unlocked all your learning materials.
                  </p>
                </div>
          ...
          <div className="mt-6 flex items-center justify-center gap-2 text-muted-foreground text-sm py-2 bg-accent rounded-lg">
            ...
            <span>A confirmation and receipt have been sent to <strong>student@example.com</strong></span>
          </div>
