...
import {
  ...
  PlayCircle, FileText, CheckCircle, Monitor, Download, Infinity,
    ...
    <MainLayout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-8">
        ...
        <nav className="flex mb-6 text-sm font-medium text-muted-foreground gap-2 items-center">
          ...
          <span className="hover:text-primary cursor-pointer">User Experience</span>
          <ChevronRight className="size-3" />
          <span className="text-foreground">Advanced UI/UX Masterclass</span>
        </nav>
          ...
          <div className="lg:col-span-8">
            <div className="mb-8">
              <h1 className="text-4xl font-extrabold mb-4 leading-tight">
                Advanced UI/UX Design Masterclass: High-End Product Strategy
              </h1>
              <p className="text-lg text-muted-foreground mb-6 max-w-2xl">
                Master the art of creating sophisticated digital products. Learn design psychology, advanced prototyping, and modern workflow integration.
              </p>
              <div className="flex flex-wrap items-center gap-6 text-sm">
                <div className="flex items-center gap-1">
                  <span className="text-warning font-bold">4.9</span>
                  <div className="flex text-warning">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} className="size-4 fill-current" />
                    ))}
                  </div>
                  <span className="text-muted-foreground underline cursor-pointer ml-1">(12,450 ratings)</span>
                </div>
            ...
            <section className="pb-20">
              ...
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-bold text-primary mb-1">Marcus Thorne</h3>
                  <p className="text-muted-foreground mb-4 font-medium uppercase tracking-wider text-xs">
                    Principal Product Designer @ TechGiant
                  </p>
              ...
              <div className="bg-card border border-border rounded-2xl shadow-xl overflow-hidden">
                <div className="p-6">
                  <div className="flex items-baseline gap-2 mb-6">
                    <span className="text-4xl font-black">$89.99</span>
                    <span className="text-muted-foreground line-through text-lg">$149.99</span>
                    <span className="text-success font-bold text-sm ml-auto">40% Off</span>
                  </div>
                  ...
                  <div className="space-y-4 mb-8">
                    ...
                    <ul className="space-y-3">
                      {[
                        { icon: Monitor, text: "24.5 hours on-demand video" },
