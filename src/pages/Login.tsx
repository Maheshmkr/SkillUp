...
const Login = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (email === "mahesh@gmail.com" && password === "gokii@143") {
      navigate("/");
    } else {
      ...
      <section className="flex-1 flex flex-col bg-card p-8 md:p-12 lg:p-20 overflow-y-auto">
        <div className="max-w-[440px] w-full mx-auto my-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button type="submit" className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-bold py-3.5 px-4 rounded-xl shadow-lg shadow-primary/20 transition-all flex items-center justify-center gap-2 mt-6">
              <span>Login</span>
